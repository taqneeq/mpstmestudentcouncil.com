          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 text-center" data-aos="fade-up">
              <div>
                ...
                <Image className="rounded-full" src={GeneralTest} width={150} height={150} alt="Testimonial 02" />
              ...
              <blockquote className="text-lg text-gray-400 grow">— Lorem, ipsum dolor sit amet consectetur adipisicing elit. </blockquote>
